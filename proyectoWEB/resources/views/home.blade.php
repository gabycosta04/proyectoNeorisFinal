    ...
    <section class="contenedor sobre-nosotros">
        ...
        <section class="clientes contenedor">
            ...
            <div class="cards">
                ...
                <div class="card">
                    <img src="{{ asset('src/Emiliano.jpg') }}" alt="">
                    <div class="contenido-texto-card">
                        <h4></h4>
                        <a href="https://www.linkedin.com/in/cristian-gabriel-costa-1bb64a1b2/" style="color:#00A0C6; text-decoration:none; cursor:pointer;">Emiliano Castell</a>
                    </div>
                </div>
                <div class="card">
                    <img src="{{ asset('src/Eduardo.jpg') }}" alt="">
                    <div class="contenido-texto-card">
                        <h4></h4>
                        <a href="https://www.linkedin.com/in/cristian-gabriel-costa-1bb64a1b2/" style="color:#00A0C6; text-decoration:none; cursor:pointer;">Eduardo Lucero</a>
                    </div>
                </div>
            </div>
        </section>
